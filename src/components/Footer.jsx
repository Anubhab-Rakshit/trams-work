...
const LINKS = {
  ...
  'Locate Us': ['376A, Town City UK\nRoad 42, CA 95082', '(219) 555-0114', 'elementium.com'],
};
      ...
      <div className={styles.links}>
        <div className={styles.brandCol}>
          <div className={styles.footerLogo}>
            <span className={styles.logoDot} />Elementium
          </div>
          <p className={styles.brandTagline}>
            We build digital<br />experiences that matter.
          </p>
          <p className={styles.copy}>© {new Date().getFullYear()} Elementium. All rights reserved.</p>
        </div>
