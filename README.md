# 💎 Elementum | Premium Corporate Landing Page
...
1.  **Clone & Install**
    ```bash
    git clone https://github.com/Anubhab-Rakshit/elementum-task.git
    cd elementum-task
    npm install
    ```
...
Elementum was built to prove that "fidelity matters." Every curve in the winding red stroke, every jitter in the zigzag marker, and every pixel in the typography collage was implemented to demonstrate a high level of technical craftsmanship and attention to detail.
